  ...
  return(
    <div className="recipe-div">
      <div>
        {/* Recipe for ID: {id} */}
        <h3>{recipe.title}</h3>
        <div style={{width: "100%", height: "80%", backgroundImage: `url(${recipe.picture})`, backgroundSize: "contain", backgroundRepeat: "no-repeat", backgroundPosition: "center"}}></div>
      </div>
      <div>
        <h4>Zutaten:</h4>
        <div className="ingrediens">
          {recipe.ingrediens.map(ingredient => {
            return <div key = {uuidv4()} style={{minWidth: "150px"}}>
      ...
      <div style={{display: "flex", flexDirection: "column"}}>
        <h4>Beschreibung:</h4>
        {recipe.description}
        <div style={{display: "flex", flexDirection: "column", alignSelf: "center", justifyContent: "flex-end", fontStyle: "normal", height: "100%"}}>
          <ReactStars count={5} value={recipe.rating} size={50} isHalf={true} edit={false} />
